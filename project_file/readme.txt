...
5. Написать методику оценки эффективности портфеля с учетом регулярного пополнения (XIRR, коэффициент Шарпа, максимальную просадку, TWRR)
    ...
    5.5.1 протестировать корректность расчета TWRR
    5.6 Сделать единый интерфейс, в который передавать в DataFrame даты, стоимость портеля/бумаги на эту дату и денежный поток на дату с соответствующим знаком.
...
Вопросы на встречу с Виктором:
27.09
1. Показать присвоение и получени значения через iloc
